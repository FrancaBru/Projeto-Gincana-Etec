  ...
  <body>
    ...
    <main>
      ...
      <div class="container droppedHover">
        <form class="form-signin" role="form" method="post" action="salvar_cancelamento_pontos.php">
          <div>
            <div>
                  ...
                  echo '<table class="table table-hover table_font">';
                    ...
                    echo '<tbody>';
                      ...
                      echo '<tr>';
                        ...
                        echo '<td>'."<a href=salvar_cancelamento_pontos.php?id=$vID>Cancelar</a>".'</td>';
                      echo '</tr>';
                      }
                    echo '</tbody>';
                  echo '</table>';
