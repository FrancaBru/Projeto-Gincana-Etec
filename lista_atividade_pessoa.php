...
<html lang="PT-BR">
	<head>
		<title>Lista de atividade por pessoa.</title>
	...
	<body>
		...
		<!-- conteudo principal !-->
		<main>
			<h1 class="titulo_tela"><i>Lista de atividades por pessoa<i></h1>
								...
								echo '<table class="table table-hover table_font">';
									...
									echo '<tbody>';
										...
										echo '<tr>';
											...
											echo '<td>'."<a href=alterar_atividade.php?id=$vID>Selecionar</a>".'</td>';
										echo '</tr>';
										}
									echo '</tbody>';
								echo '</table>'
